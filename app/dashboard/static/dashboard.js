...
<td data-label="Modal"><span class="ao-capital">${moneyFull(modal)}</span><small>${fmt(size)} unit</small></td>
<td data-label="Unrealized PnL"><span class="ao-pnl ${pnlCls}" id="ao-pnl-${esc(sym)}">${pnl>=0?"+":""}${moneyFull(pnl)}<small>${pnlPct>=0?"+":""}${pnlPct.toFixed(2)}%</small></span></td>
