...
<td data-label="Stop Loss"><span class="ao-sl${slWarn}">${sl?fmtPrice(sl):"-"}${sl&&distToSl?`<small>SL ${distToSl.toFixed(2)}%</small>`:""}</span></td>
